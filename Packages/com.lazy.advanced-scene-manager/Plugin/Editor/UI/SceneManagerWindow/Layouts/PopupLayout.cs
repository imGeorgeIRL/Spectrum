...
namespace AdvancedSceneManager.Editor.UI.Layouts
{
    ...
    abstract class PopupLayout<T> : ViewLayout<T> where T : IView
    {
        ...
        public override void OnWindowDisable() => currentPopup?.OnWindowDisable();
        public override void OnWindowEnable() => currentPopup?.OnWindowEnable();
        public override void OnWindowFocus() => currentPopup?.OnWindowFocus();
        public override void OnWindowLostFocus() => currentPopup?.OnWindowLostFocus();
