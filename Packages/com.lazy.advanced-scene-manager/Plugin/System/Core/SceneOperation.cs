...
namespace AdvancedSceneManager.Core
{
    ...
    public class SceneOperation : CustomYieldInstruction, IQueueable
    {
        ...
        public bool focusSingleScene => m_focusSingleScene;
        ...
        IEnumerator Run()
        {
            ...
            //Wait for any other operations that this one should wait for
        ...
        void SetActiveScene(Scene except = null)
        {
            ...
            if (!scene && setActiveCollectionScene && collection && collection.activeScene && collection.activeScene != except)
                scene = collection.activeScene;

            if (!scene && focusSingleScene)
                scene = openedScenes.FirstOrDefault();
