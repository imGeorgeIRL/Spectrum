...
namespace AdvancedSceneManager.Models
{
    ...
    public class Profile : ASMModel
    {
        ...
        {
            var collection = CreateDynamicCollection("Packages/com.lazy.advanced-scene-manager/Default scenes", "ASM Defaults");
...
#if INPUTSYSTEM
            AddDefaultBindingScene(SceneManager.assets.defaults.pauseScene, escape, start);
            AddDefaultBindingScene(SceneManager.assets.defaults.inGameToolbarScene, tab, select);
            Save();
#endif
