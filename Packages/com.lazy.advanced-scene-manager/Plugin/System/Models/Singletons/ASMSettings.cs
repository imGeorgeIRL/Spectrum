...
namespace AdvancedSceneManager.Models
{
    ...
    public class ASMSettings : ASMScriptableSingleton<ASMSettings>, INotifyPropertyChanged, IProjectSettings
    {
        ...
        void UpdateBlocklists()
        {
            ...
            if (m_blacklistOld?.Count > 0)
            {
                m_blacklist.list.AddRange(m_blacklistOld);
                m_blacklistOld = null;
                EditorUtility.SetDirty(this);
            }

            if (m_whitelistOld?.Count > 0)
            {
                m_whitelist.list.AddRange(m_whitelistOld);
                m_whitelistOld = null;
                EditorUtility.SetDirty(this);
            }
        ...
        [Header("Scenes")]
        [SerializeField, FormerlySerializedAs("m_blacklist")] internal List<string> m_blacklistOld = new();
        [SerializeField, FormerlySerializedAs("m_whitelist")] internal List<string> m_whitelistOld = new();
