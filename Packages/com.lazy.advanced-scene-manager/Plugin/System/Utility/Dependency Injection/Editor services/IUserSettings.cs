...
namespace AdvancedSceneManager.DependencyInjection.Editor
{
    ...
    public interface IUserSettings : DependencyInjectionUtility.IInjectable
    {
        ...
        /// <inheritdoc cref="ASMUserSettings.displayBuildProfilesButton"/>
        bool displayBuildProfilesButton { get; set; }

        /// <inheritdoc cref="ASMUserSettings.displayCodeEditorButton"/>
        bool displayCodeEditorButton { get; set; }
        ...
        /// <inheritdoc cref="ASMUserSettings.displayDevBuildButton"/>
        bool displayDevBuildButton { get; set; }
        ...
        /// <inheritdoc cref="ASMUserSettings.displayOverviewButton"/>
        bool displayOverviewButton { get; set; }

        /// <inheritdoc cref="ASMUserSettings.displayProfileButton"/>
        bool displayProfileButton { get; set; }

        /// <inheritdoc cref="ASMUserSettings.displayProjectSettingsButton"/>
        bool displayProjectSettingsButton { get; set; }

        /// <inheritdoc cref="ASMUserSettings.displaySceneHelperButton"/>
        bool displaySceneHelperButton { get; set; }

        /// <inheritdoc cref="ASMUserSettings.displaySearchButton"/>
        bool displaySearchButton { get; set; }
